...
class BUTTONS(object):
    MBUTTON = [[InlineKeyboardButton("𝕮ʜᴀᴛ𝕲𝕻𝕿", callback_data="mplus HELP_ChatGPT"),InlineKeyboardButton("♓ɪ💲ᴛᴏʀʏ", callback_data="mplus HELP_History"),InlineKeyboardButton("Rᴇᴇʟ", callback_data="mplus HELP_Reel")],
    ...
    InlineKeyboardButton(".•♫•♬• Ꮦʀᴜᴛʜ-ᗪᴀʀᴇ •♬•♫•.", callback_data="mplus HELP_TD"),InlineKeyboardButton("✌𝓠ᴜɪᴢ✌", callback_data="mplus HELP_Quiz")], 
    [InlineKeyboardButton("♪·¯·♫¸¸ ᴛᴛ𝓼¸¸♫·¯·♪", callback_data="mplus HELP_TTS"),
    InlineKeyboardButton("🥂🍸 𝓡ᴀᴅɪᴏ 🍻🍷", callback_data="mplus HELP_Radio"),InlineKeyboardButton("ǫᴜᴏᴛʟʏ", callback_data="mplus HELP_Q")],          
